                    ...
                    <div className='flex items-center gap-2 opacity-70'>
                            {
                                role === 'user' ? (
                                    ...
                                    <Image src={assets.pencil_icon} alt='copy' className='w-4.5 cursor-pointer' />

                                    </>
                                ): (
                                    <>
                                    <Image src={assets.copy_icon} alt='copy' className='w-4 cursor-pointer' />
                                    <Image src={assets.regenerate_icon} alt='copy' className='w-4 cursor-pointer' />
                                    <Image src={assets.like_icon} alt='copy' className='w-4 cursor-pointer' />
                                    <Image src={assets.dislike_icon} alt='copy' className='w-4 cursor-pointer' />
